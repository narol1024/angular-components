...
gulp.task('uglifyjs', function() {
    return gulp.src(['./src/js/angular-itempicker.js'].concat(jsFolder))
        .pipe(concat('angular-itempicker.js'))
        .pipe(gulp.dest('./dist/js/'))
        .pipe(rename({suffix: '.min'}))
        .pipe(uglifyjs())
        .pipe(gulp.dest('./dist/js/'));
...
gulp.task('start', function() {
    ...
    gulp.watch(['./src/js/angular-itempicker.js'].concat(jsFolder), ['uglifyjs']);
    gulp.start('uglifyjs');
    gulp.start('connect');
});
